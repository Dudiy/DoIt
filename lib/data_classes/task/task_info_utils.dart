...
class TaskUtils {
  ...
  static TaskInfo generateTaskInfoFromObject(taskObject) {
    ...
    return new TaskInfo(
        ...
        parentGroup: GroupUtils.generateShortGroupInfoFromObject(taskObject['parentGroup']),
  ...
  static ShortTaskInfo generateShortTaskInfoFromObject(object) {
    ...
    return new ShortTaskInfo(
      ...
      parentGroup: GroupUtils.generateShortGroupInfoFromObject(object['parentGroup']),
  ...
  static Map<String, dynamic> generateObjectFromShortTaskInfo(ShortTaskInfo shortTaskInfo) {
    return {
      ...
      'parentGroup': GroupUtils.generateObjectFromShortGroupInfo(shortTaskInfo.parentGroup),
  ...
  static Map<String, dynamic> generateObjectFromTaskInfo(TaskInfo taskInfo) {
    return {
      ...
      'parentGroup': GroupUtils.generateObjectFromShortGroupInfo(taskInfo.parentGroup),
